...
\begin{document}
  ...
  \framebox[6in][c]{
    \parbox{6in}{\centering
      ...
      \url{https://github.com/skytreader/chad-cv}. This version was generated at 2023-10-03.
    }
  }
  \vspace{0.2in}
  \\
  \resumesection{Work Experience}
    \begin{itemize}
      ...
      \techused{Java, Node, TypeScript, Vue.js, AWS (EC2/ECS, Lambda, API Gateway,
      S3, DynamoDB, etc.), Serverless, MySQL, Jenkins.}
      ...
      SASS, Bootstrap, Python, Pyramid, Celery, Docker, Kubernetes, Jenkins.}
